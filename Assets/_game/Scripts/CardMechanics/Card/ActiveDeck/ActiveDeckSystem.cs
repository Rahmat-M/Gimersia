...
namespace Littale {
    public class ActiveDeckSystem : MonoBehaviour {
        ...
        public CardDataSO startingActiveCard;
        ...
        // Events
        public delegate void ActiveCardDrawnHandler(CardDataSO card);
        public event ActiveCardDrawnHandler OnActiveCardDrawn;

        public delegate void ActiveCardUsedHandler(CardDataSO card);
        ...
        public delegate void ChannelingStartedHandler(CardDataSO card, float duration);
        ...
        // Getters
        public CardDataSO GetActiveCard() => activeCard;
