...
public class ActiveDeckUI : MonoBehaviour
{
    ...
    void HandleActiveCardUsed(CardData card)
    {
    ...
    void HandleChannelingStarted(CardData card, float duration)
    {
