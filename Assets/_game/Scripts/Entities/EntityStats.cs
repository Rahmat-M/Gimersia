...
namespace Littale {
    ...
    public abstract class EntityStats : MonoBehaviour {
        ...
        protected virtual void Start() {
            ...
            if (sprite == null) sprite = GetComponentInChildren<SpriteRenderer>(); // Try to get sprite from children as well.
            originalColor = sprite.color;
            animator = GetComponent<Animator>();
            if (animator == null) animator = GetComponentInChildren<Animator>(); // Try to get animator from children as well.
        }
